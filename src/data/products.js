// Premium Product Collection for Siwach Enterprises - Enhanced with Premium Names, Descriptions & New Products
export const allProducts = [
  // Running Collection - Enhanced with Premium Names & Descriptions
  {
    id: 1,
    name: 'Velocity Pro Max ELITE Edition',
    category: 'running',
    price: 12999,
    originalPrice: 15999,
  ...
  {
    id: 2,
    name: 'AeroStrike Runner PLATINUM',
    category: 'running',
    price: 8999,
    originalPrice: 11999,
  ...
  {
    id: 44,
    name: 'Elegance Training SOPHISTICATION',
    category: 'women',
    gender: 'women',
    price: 9999,
...
// Helper functions - Enhanced to support new categories
...
export const getProductsByGender = (gender) => {
  ...
  return allProducts.filter(product => {
    // Check explicit gender property first
    if (product.gender) return product.gender === gender;
    
    // Fallback to category-based gender detection
    if (gender === 'women') return product.category === 'women';
    if (gender === 'men') return !['women', 'tech'].includes(product.category);
    return true;
  });
};
...
export const getTechProducts = () => {
  return allProducts.filter(product => product.category === 'tech');
};

export const getWomenProducts = () => {
  return allProducts.filter(product => product.category === 'women' || product.gender === 'women');
};

export const getMenProducts = () => {
  return allProducts.filter(product => 
    !['women', 'tech'].includes(product.category) && product.gender !== 'women'
  );
};
